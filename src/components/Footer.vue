<template>
  <div class="bg-black">
      <div class="justify-center py-20 px-10 sm:px-40 bg-main-color w-full flex flex-col sm:flex-row">
        ...
        <el-button class="mt-5 sm:mt-auto sm:ml-auto my-auto bg-transparent border-black hover:bg-black hover:text-main-color text-black"><a href="https://github.com/denyncrawford" target="_blank" rel="noopener noreferrer">Support DnDB</a></el-button>
      </div>
    </div>

  ...
  <div>
    <page>
      <div class="ml-32">
        ...
        <br><br>
        We always keep advancing and improving DnDB, making it a reliable and stable module for using in production.</p>
        <h1 class="text-main-color mt-32 text-5xl max-w-xl">Is DnDB the wae?</h1>
        <p class="mt-10 max-w-prose">DnDB is an optimized data store made for the Deno runtime, with no bottlenecks or exaggerated load times, this is possible because it does not hold all the data in memory.
        <br><br>
        ...
        But if you want to support the Deno comunity making awesome stuff with awesome stuff...
        <span class="text-main-color">This is the wae</span>.
        </p>
      </div>
    </page>
  </div>
